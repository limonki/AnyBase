...
if($flag)
{
  setcookie('title', conv2Send2JS($lang->get('MSG_BCK_RESTORE_SUCC_TITLE')), 0, '/');
  setcookie('msg', conv2Send2JS($lang->get('MSG_BCK_RESTORE_SUCC_MSG')), 0, '/');
...
{
  setcookie('title', conv2Send2JS($lang->get('MSG_BCK_RESTORE_ERR_TITLE')), 0, '/');
  setcookie('msg', conv2Send2JS($lang->get('MSG_BCK_RESTORE_ERR_MSG')), 0, '/');
  setcookie('close', conv2Send2JS($lang->get('CLOSE')), 0, '/');
